...
/// 22 adds the render-neutral `encoder_hints` contract to every completed or
///   analyzed file. Schemas 20/21 were the short-lived semantic-only reports.
pub const REPORT_SCHEMA_VERSION: u32 = 22;
/// Schema 23 carries observational semantic evidence plus encoder hints. Schema
